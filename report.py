...
class reportClass:
    def __init__(self,root):
        ...
        self.var_id=""
        lbl_search=Label(self.root,text="Search By Roll No.",font=("goudy ols style",20,"bold"),bg="white").place(x=280,y=100)
        txt_search=Entry(self.root,textvariable=self.var_search,font=("goudy ols style",20),bg="lightyellow").place(x=540,y=100,width=150)

        btn_search=Button(self.root,text='Search',font=("goudy old style",15,"bold"),bg="#03a9f4",fg="white",cursor="hand2",command=self.search).place(x=700,y=100,width=120,height=35)
        btn_clear=Button(self.root,text='Clear',font=("goudy old style",15,"bold"),bg="gray",fg="white",cursor="hand2",command=self.clear).place(x=840,y=100,width=120,height=35)
